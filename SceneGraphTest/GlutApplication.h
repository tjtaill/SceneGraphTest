...
private:
	...
	static void OnKeyPressedCallWrapper(unsigned char keyPressed, int x, int y);
...
protected:
	...
	GlutApplication(int argc, char** argv, 
		...
		int xWindowPositon=100, int yWindowPosition=100, unsigned int displayMode = GLUT_DOUBLE | GLUT_RGBA | GLUT_DEPTH);
...
public:
	...
	/**
	  ...
	  *@todo consider making this method static so it can't be overriden or hidden
	  */
