		...
		displayMode_(displayMode)
{
	...
	glutKeyboardFunc( &GlutApplication::OnKeyPressedCallWrapper );
...
void GlutApplication::OnMousePressedCallWrapper(int button, int state, int x, int y)
{
 ...
 void GlutApplication::OnKeyPressedCallWrapper(unsigned char keyPressed, int x, int y)
{
	
	glutApplicationPointer->OnKeyPressed(keyPressed, x, y);
}
